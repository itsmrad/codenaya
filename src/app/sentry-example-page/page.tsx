...
export default function Page() {
	...
	useEffect(() => {
		...
		// Skip diagnoseSdkConnectivity() check — it tests direct connectivity
		// to *.sentry.io which is blocked by our network. Errors are sent
		// successfully via the tunnel route (/monitoring) configured in
		// instrumentation-client.ts and next.config.ts.
	}, []);
			...
			<main>
				...
				<p className="description">
					...
					<a
						target="_blank"
						rel="noopener"
						href="https://itsmrad.sentry.io/issues/?project=4510893932281936">
						Issues Page
					</a>
